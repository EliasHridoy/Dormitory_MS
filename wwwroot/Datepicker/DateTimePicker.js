(function ($) {
	...
	function DateTimePicker(options) {
		...
		for (i = 0; i < 60;i+=30) html2 = minutsHTML.append("<option>" + i + "</option");
		minutsHTML.append("<option>" + 40 + "</option");
		minutsHTML.append("<option>" + 50 + "</option");
		html3 = secondHTML.append("<option>" + 0 + "</option");
	}
